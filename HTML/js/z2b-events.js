...
{
    let _a = new Array()
    for (let each in _in){(function(_idx, _arr){console.log('_arr['+_idx+'].id.slice(0,10) is: '+_arr[_idx].id.slice(0,10)); if (_arr[_idx].id.slice(0,10) !== 'noop@dummy')_a.push(_arr[_idx]);})(each, _in);}
    return _a;
}
/**
